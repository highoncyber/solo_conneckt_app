...
class SingleGroupChatScreen extends StatefulWidget {
  SingleGroupChatScreen(
  ...
  @override
  State<SingleGroupChatScreen> createState() => _SingleGroupChatScreenState();
}

class _SingleGroupChatScreenState extends State<SingleGroupChatScreen> {
                  ...
                  builder: (BuildContext context, AsyncSnapshot snapshot) {
                    if (snapshot.data == null) {
                      ...
                      return ListView.builder(
                        ...
                        // controller: _scrollController.animateTo(listViewScrollController.position.maxScrollExtent),
