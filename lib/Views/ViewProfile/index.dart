...
class ViewProfile extends StatefulWidget {
  String id;
  String LogedInid;
  ViewProfile({required this.id, required this.LogedInid, Key? key})
      : super(key: key);
...
class _ViewProfileState extends State<ViewProfile> {
  ...
  getProfile() async {
    var url = Uri.parse(base_url + ApiUrl.getUser(widget.id, widget.LogedInid));
    print(url);
                            ...
                            children: [
                              ...
                              Row(
                                ...
                                children: [
                                        ...
                                        MaterialPageRoute(
                                            builder: (context) =>
                                                DirectUserChat(
                                                  ...
                                                  name: JsonData[0]
                                                      ["user_name"],
                                                      isExchange:JsonData[0]
                                                      ["is_connect"]=="1"?"false": "true",
                                                )),
                                      );
                                    },
                                    icon:
                                  ...
                                  InkWell(
                                    onTap: () async {
                                      if (JsonData[0]["is_blocked"] != "1") {
                                        await ApiCall().BlockUser(
                                            widget.LogedInid,
                                            widget.id,
                                            context);
                                        getProfile();
                                      } else {
                                        await ApiCall().UnblockUser(
                                            widget.LogedInid,
                                            widget.id,
                                            context);
                                        getProfile();
