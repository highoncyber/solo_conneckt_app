...
import 'package:soloconneckt/Views/NewsFeed/swipeCard.dart';
...
class StatusCircleWidget extends StatelessWidget {
  int index;
  String image, user_id, user_name, postimage;
  StatusCircleWidget({
    required this.index,
    required this.image,
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    user_name,
                    style: ThemeHelper()
                        .TextStyleMethod1(12, context, FontWeight.w900),
                  ),
                ],
              ),
            ),
